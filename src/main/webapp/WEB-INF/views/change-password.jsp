...
<body>
	<div class="main">
		<div class="container a-container" id="a-container">
			<form class="form" id="a-form" method="post" action="/asm/changePass">
				...
				<span class="form__span">Enter the password you want to change</span>
				<input class="form__input" type="email" placeholder="Email" name="email" value="${email.email}" disabled>
				<input class="form__input" type="password" placeholder="Password" name="oldpass">
				<input class="form__input" type="password" placeholder="Password" name="pass">
				<input class="form__input" type="password" placeholder="Confirm password" name="confirmPass">
				<div class="text-start text-danger w-75 ps-5"><span style="color: red">${msg}</span></div>
				<div class="text-start text-danger w-75 ps-5"><a href="/asm/index" style="color: black">Bach to home page</a></div>
				<button class="form__button button submit" formaction="/asm/changePass">CHANGE</button>
			</form>
		</div>
*
	</div>
